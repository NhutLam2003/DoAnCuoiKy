...
class _Tin_NongState extends State<Tin_Nong> {
  ...
  void fetchNewsData() async {
    ...
    var fetchedNewsList = await newsDataFetcher
        .fetchNewsData('https://vnexpress.net/rss/tin-xem-nhieu.rss');
    var fetchedNewsListNoiBat = await newsDataFetcherNoiBat
        .fetchNewsData('https://vnexpress.net/rss/tin-noi-bat.rss');
    setState(() {
    ...
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
          ...
          if (newsList.isNotEmpty) const Padding(padding: EdgeInsets.all(5)),
          if (newsList.isNotEmpty)
          ...
          ListView.builder(
              ...
              itemBuilder: (context, index) {
                ...
                return CustomItem_List(
                  ...
                  link: link.toString(),
                  date: chuanHoaDate(date.toString()),
                );
              })
          ///////////////////////////////////////////////////////////
        ],
  ...
  Widget Item(String img, int index, String name, String link) {
    ...
    final imgWidget = (img != null && img.isNotEmpty)
        ? Image.network(
            img,
            fit: BoxFit.cover,
    ...
    return GestureDetector(
      child: Container(
        ...
        child: Stack(children: [
          ClipRRect(borderRadius: BorderRadius.circular(15), child: imgWidget),
          Container(
      ...
      onTap: () async {
        ...
        if (await canLaunchUrl(url)) {
          ...
          Navigator.push(
            context,
            MaterialPageRoute(
              builder: (context) => ChiTietPage(url: link),
            ),
          );
        }
      },
